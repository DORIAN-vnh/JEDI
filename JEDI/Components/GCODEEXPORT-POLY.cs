...
{
    public class GCodeExporterPOLY : GH_Component
    {
        public GCodeExporterPOLY() : base("GCode Exporter POLYLIGNE", "GCodeExp-POLYLIGNE",
        ...
        public override Guid ComponentGuid => new Guid("F209FA87-C36D-4A63-97B2-BF25D7CDE8AB");
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (var path in paths)
            {
                ...
                else
                {
                    ...
                    Polyline poly;
                    if (simplified != null && simplified.TryGetPolyline(out poly))
                    {
                        if (poly.Count > 0)
                        {
